...
// File: contracts/Homework/SmartBank.sol
...
contract SmartBank {
    ...
    constructor() payable {
        ...
        swapRouter = ISwapRouter(0xC532a74256D3Db42D0Bf7a0400fEFDbad7694008);
    ...
    function withdrawERC20Token(uint _amount) public {
      ...
      function swapCoffeeTokenForWETH(uint256 _coffeeTokenAmount) external returns (uint256 _out) {
